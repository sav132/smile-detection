...
########################################################
imgMustache = cv2.imread('happy.jpeg',-1)
...
while True:
    ...
    for face_coordinates in faces:
        ...
        #roi_color = frame[y1:y2+3, x1:x2+2]
        #print(x1,x2,y1,y2)
    ...
    #print("\n")
            ...
            if emotion_probability >0.70 :
                        if emotion_text == 'happy' and area >= 20000:
                            ...
                            bgr_image[y_offset:y_offset+s_img.shape[0], x_offset:x_offset+s_img.shape[1]] = s_img
